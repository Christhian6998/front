...
export const routes: Routes = [
    ...
    //Rutas postulantes
    {path: 'test', component: TestComponent, canActivate: [RoleGuard]},
    { path: 'historial', component: HistorialTest },

    //Rutas Admin
    { path: 'gestionOferta', component: GestionOferta },
    { path: 'gestionPregunta', component: GestionPregunta }
];
